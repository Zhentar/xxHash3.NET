...
namespace xxHash3.Benchmarks
{
	...
	public sealed class YYProject_XXHash64 : HashAlgorithm
	{
		...
		/// </summary>
		/// <returns></returns>
		public new static YYProject_XXHash64 Create() => new YYProject_XXHash64();
		...
		public new static YYProject_XXHash64 Create(string algName) => throw new NotSupportedException("This method is not be supported.");

		/// <summary>
		/// Initializes a new instance of the <see cref="XXHash64"/> class by default seed(0).
		/// </summary>
		public YYProject_XXHash64() => Initialize(0);
		...
		public YYProject_XXHash64(uint seed) => Initialize(seed);
